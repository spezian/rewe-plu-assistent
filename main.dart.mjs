...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      ZI: x0 => globalThis.Object.keys(x0),
      ...
      eH: x0 => x0.next(),
      eI: (x0,x1) => new SharedWorker(x0,x1),
      ...
      gG: (x0,x1) => { x0.type = x1 },
      gH: x0 => x0.done,
      gI: (x0,x1,x2) => x0.postMessage(x1,x2),
      ...
      kI: (x0,x1,x2) => x0.postMessage(x1,x2),
      kJ: x0 => x0.response,
      kK: (a, l) => a.length = l,
      ...
      oI: (x0,x1) => x0.getRandomValues(x1),
      oJ: () => {
      ...
      qI: l => new DataView(new ArrayBuffer(l)),
